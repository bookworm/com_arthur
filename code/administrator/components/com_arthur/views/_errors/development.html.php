...
<div class="arthur-exception-class">
	<?=get_class($exception);?>
...
<div class="arthur-exception-message"><?=$exception->getMessage(); ?></div>
		...
		<?php foreach($stack as $id => $frame): ?>
			...
			<li>
				...
				<div id="sourceCode<?=$id; ?>" style="display: none;">
					...
					<div class="arthur-exception-location">
						<?=$location; ?>
					</div>

					<div class="arthur-code-dump">
						<pre><code><?php
